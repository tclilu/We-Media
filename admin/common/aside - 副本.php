<div class="aside">
    ...
    <ul class="nav">
        <?php $posts_menu = array('posts','post-add','categories');?>
        <li <?php echo $current_page === 'index'?'class="active"':'';?> >
            <a href="index.php"><i class="fa fa-dashboard"></i>仪表盘</a>
        </li>
        <li <?php echo in_array($current_page,$posts_menu)?'class="active"':'';?> >
            <a href="#menu-posts" class="collapsed" data-toggle="collapse">
                <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
            </a>
            <ul id="menu-posts" class="collapse <?php echo in_array($current_page,$posts_menu)?'in':'';?>">
        ...
        <?php $settings_menu=array('nav-menus','slides','settings');?>
        <li <?php echo in_array($current_page,$settings_menu)?'class="active"':'';?>>
            <a href="#menu-settings" class="collapsed" data-toggle="collapse">
                <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
            </a>
            <ul id="menu-settings" class="collapse <?php echo in_array($current_page,$settings_menu)?'in':'';?>">
